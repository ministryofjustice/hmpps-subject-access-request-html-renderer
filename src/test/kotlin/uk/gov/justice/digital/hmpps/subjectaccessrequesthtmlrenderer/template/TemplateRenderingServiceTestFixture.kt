...
abstract class TemplateRenderingServiceTestFixture {

  companion object {
    @JvmStatic
    fun serviceWithMandatoryTemplates() = listOf("GOne", "GTwo", "GThree")

    fun loadServiceFixture(serviceName: String): Any {
    ...
    val testServiceTemplateData: ArrayList<Any> = arrayListOf(
      mapOf(
    ...
    val testKeyworkerServiceData: ArrayList<Any> = arrayListOf(
      mapOf(
    ...
    val testActivitiesServiceData: ArrayList<Any> = arrayListOf(
      mapOf(
    ...
    val testIncentivesServiceData: ArrayList<Any> = arrayListOf(
      mapOf(
        "id" to 2898970,
    ...
    val testAdjudicationsServiceData: ArrayList<Any> = arrayListOf(
      mapOf(
    ...
    val testHDCServiceData: ArrayList<Any> = arrayListOf(
      mapOf(
    ...
    val testUseOfForceServiceData: ArrayList<Any> = arrayListOf(
      mapOf(
        "id" to 190,
        "sequenceNo" to 2,
    ...
    val testResettlementPassportServiceData: Map<Any, Any> = mapOf(
      "prisoner" to mapOf(
        "id" to 3,
        "nomsId" to "A8731DY",
    ...
    val testCourtCaseServiceData = mapOf(
    ...
    val testAccreditedProgrammesServiceData: Map<Any, Any> = mapOf(
    ...
    val testNonAssociationsServiceData = mapOf(
      "prisonerNumber" to "A4743DZ",
    ...
    val testInterventionsServiceData: Map<Any, Any> = mapOf(
      "crn" to "X718253",
    ...
    val testCategorisationServiceData: Map<Any, Any> = mapOf(
